            ...
            >
                ...
                >
                    <h2 className="text-3xl sm:text-4xl md:text-4xl font-bold text-white mb-6 tracking-tight leading-tight">
                        Crafting Digital <span className="text-teal-400">Interactions</span>
                    </h2>
                    ...
                    <div className="flex gap-8 mt-10 pt-8 border-t border-white/10">
                        ...
                        <div>
                            <h4 className="text-2xl md:text-3xl font-bold text-teal-400 tracking-tight">MERN</h4>
                ...
                <div className="lg:col-span-5 flex flex-col gap-4">
                    ...
                    <motion.div 
                        ...
                        className="p-5 rounded-2xl border border-teal-500/20 bg-teal-500/[0.02] hover:bg-teal-500/[0.05] flex items-center justify-between group cursor-pointer transition-all duration-300 mt-2"
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-sm md:text-base font-semibold text-white group-hover:text-teal-400 transition-colors">Hire Me / Get in touch</h4>
                            </div>
                        </div>
                        <div className="text-gray-400 group-hover:text-teal-400 group-hover:translate-x-1 transition-all duration-300">
