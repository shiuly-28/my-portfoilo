        ...
        <div className="min-h-[90vh] flex items-center justify-center py-12 px-4  overflow-hidden">
            <div className="flex flex-col-reverse lg:flex-row items-center gap-12 max-w-7xl mx-auto">
                ...
                <div className="text-center lg:text-left flex-1">
                    ...
                    >
                        <h3 className="text-teal-500 font-mono tracking-widest mb-2 uppercase text-sm">
                            Available for Work
                        </h3>
                       ...
                       <p className="mt-6 text-gray-400 leading-relaxed max-w-xl mx-auto lg:mx-0 text-lg">
                        ...
                        <span className="text-teal-500 font-semibold"> Frontend Developer</span> specializing in the 
                         <span className="text-white font-medium italic underline decoration-teal-500/30 underline-offset-4"> MERN Stack</span>. 
                        ...
                        <div className="flex flex-wrap gap-5 justify-center lg:justify-start mt-10">
                            ...
                            <div className="flex gap-4 items-center">
                                <a href="https://github.com/shiuly-28" target="_blank" rel="noopener noreferrer" 
                                   className="p-3 bg-white/5 border border-white/10 rounded-full text-gray-400 hover:text-teal-500 hover:border-teal-500 transition-all">
                                    <FaGithub size={24} />
                                </a>
                ...
                >
                    ...
                    {/* <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-teal-500/20 rounded-full blur-[100px] animate-pulse"></div>
                    ...
                    <div className="relative group">
                        {/* Glass Border Frame */}
                        <div className="absolute -inset-4 bg-gradient-to-tr from-teal-500/20 to-blue-500/20 rounded-[3rem] blur-sm group-hover:blur-md transition-all duration-500"></div>
                        ...
                        >
                            <p className="text-teal-500 font-bold text-xl leading-none">Frontend and MERN</p>
