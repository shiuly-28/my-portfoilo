...
const Contact = () => {
    ...
    return (
        <section id="contact" className="relative py-24 px-6 overflow-hidden ">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-teal-500/5 blur-[120px] pointer-events-none"></div>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 tracking-tighter">
                        Get In <span className="text-teal-300 italic">Touch</span>
                    </h2>
                    <div className="h-1.5 w-20 bg-teal-500 mx-auto rounded-full shadow-[0_0_15px_rgba(163,230,53,0.5)]"></div>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    >
                        <div className="p-8 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-3xl shadow-2xl">
                            ...
                            <div className="space-y-4">
                                <div className="group flex items-center gap-4 p-4 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-teal-500/30 transition-all">
                            ...
                            <div className="mt-10 pt-8 border-t border-white/5 flex gap-4">
                                {[
                                    ...
                                    { icon: <FaWhatsappSquare />, link: "#", color: "hover:text-teal-400" }
                                ].map((social, idx) => (
                    ...
                    >
                        <form ref={formRef} onSubmit={handleSend} className="p-8 md:p-10 rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-3xl shadow-2xl space-y-5 relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div className="space-y-2">
                                    ...
                                    <input type="text" name="name" placeholder="John Doe" className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-teal-500/50 transition-all" required />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-xs font-bold uppercase tracking-widest text-gray-500 ml-2">Email Address</label>
                                    <input type="email" name="email" placeholder="john@example.com" className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-teal-500/50 transition-all" required />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-bold uppercase tracking-widest text-gray-500 ml-2">Your Message</label>
                                <textarea name="message" placeholder="How can I help you?" rows="5" className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-teal-500/50 transition-all resize-none" required></textarea>
                            </div>
                            ...
                            <motion.button
                                ...
                                className="w-full py-5 rounded-2xl bg-teal-600 text-white font-black uppercase tracking-widest text-sm shadow-[0_20px_40px_-10px_rgba(163,230,53,0.3)] hover:bg-teal-500 transition-all"
                            >
                                Send Message —&gt;
                            </motion.button>
                        </form>
